<template>
  <v-container py-10>
    <v-container>
      ...
      <v-layout row wrap justify-center>
        <v-flex xs12 md3 px-10 pt-10>
          ...
          <p>
            Currently in Computer Engineering
            <br />Intended Computer Engineering Major
          </p>
    ...
    <v-container>
      <v-flex mb-5 xs12 md5 mx-auto py-5 justify-center>
    ...
    <v-container>
      ...
      <v-layout mb-5 py-5 xs12 pt-5 justify-center mx-auto row wrap md5>
        <v-flex md1>
          <v-img src="../assets/dubhacks.png" width="120" height="50"></v-img>
          <h3>@UW</h3>
        </v-flex>
        <v-flex md4 pl-5>
          <h2>Detox (October 2019)</h2>
          <p>
      ...
      <v-layout xs12 pt-5 justify-center mx-auto row wrap md5>
        ...
        <v-flex md4 pl-5>
          <h2>Agenda (February 2019)</h2>
          <p>
            Created an agenda maker that helps remind the use of what to do. Customize
      ...
      <v-layout mb-5 py-5 xs12 pt-5 justify-center mx-auto row wrap md5>
        ...
        <v-flex md4 pl-5>
          <h2>Schooltools (February 2018)</h2>
          <p>
            Created a website with many tools to help aid with school subjects,
    ...
    <v-container>
      <v-flex xs12 mb-5>
        <h2
          class="headline font-weight-bold mb-3 text-center"
          id="RSOs"
        >Registered Student Organizations</h2>
        <v-layout mb-5 py-5 xs12 pt-5 justify-center mx-auto row wrap md5>
          <v-flex md1>
            <v-img src="../assets/DFA.png" width="120" contain></v-img>
            <h3>@UW</h3>
          </v-flex>
          <v-flex md4 pl-5>
            <h2>Design for America (September 2019 - Present)</h2>
            <p>
    ...
    <v-container>
      <v-flex xs12 mb-5>
        <h2 class="headline font-weight-bold mb-3 text-center">Hobbies / Random Things</h2>
        <p class="text-center">
          Evolution of my username: Noob --> Newb --> Newblett --> Nublett -->
          <b>Nubwett</b>
        </p>
        ...
        <v-layout mb-5 py-5 xs12 pt-5 justify-center mx-auto row wrap md5 text-center>
          ...
          <v-flex md3 mx-5>
            <v-card>
              ...
              <v-card-text class="text--primary body-1">
                ...
                <p>Camp Kesem UW</p>
                <p>Husky Swim Club</p>
                <p>Purple Caster Minions</p>
                <p>Gaming Association at UW</p>
                <p>Taiwanese Student Organization</p>
                <p>Chinese Student Organization</p>
                <p>Japanese Student Organization</p>
                <p>Korean Student Organization</p>
              </v-card-text>
            </v-card>
          </v-flex>
          ...
          <v-flex md3 mx-5>
            <v-card>
              <v-card-title class="justify-center">Things I Love</v-card-title>
              <v-card-text class="text--primary body-1">
                <p>
                  <a
